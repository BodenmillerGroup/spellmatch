...
spellmatch match source_masks target_masks --algorithm spellmatch --algorithm-args "intensity_transform=numpy.arcsinh,scores_tol=1.0e-9,spatial_cdist_prior_thres=15,max_spatial_cdist=15,degree_weight=1,intensity_weight=1,intensity_interp_lmd=1,distance_weight=1" --source-images source_img --target-images target_img --prior-transforms refined_transforms scores_spellmatch
