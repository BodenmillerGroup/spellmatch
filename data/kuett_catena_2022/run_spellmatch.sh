...
spellmatch assign scores_icp_forward --strategy forward_max --score-thres 0 --validate initial_assignments --source-masks source_masks --target-masks target_masks --show 100 assignments_icp_forward
spellmatch assign scores_icp_reverse --strategy reverse_max --score-thres 0 --validate assignments_icp_forward --source-masks source_masks --target-masks target_masks --show 100 assignments_icp_reverse
spellmatch combine assignments_icp_forward assignments_icp_reverse --strategy union --validate initial_assignments --source-masks source_masks --target-masks target_masks --show 100 assignments_icp
