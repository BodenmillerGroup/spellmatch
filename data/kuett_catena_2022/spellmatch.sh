...
spellmatch match source_masks target_masks --algorithm icp --algorithm-args "max_dist=15,min_change=1.0e-9" --source-images source_img --target-images target_img --prior-transforms initial_transforms_refined scores_icp_forward
spellmatch match source_masks target_masks --algorithm icp --algorithm-args "max_dist=15,min_change=1.0e-9" --source-images source_img --target-images target_img --prior-transforms initial_transforms_refined --reverse scores_icp_reverse
